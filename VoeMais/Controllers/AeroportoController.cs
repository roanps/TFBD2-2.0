...
namespace VoeMais.Controllers
{
    public class AeroportoController : Controller
    {
        ...
        public AeroportoController(VoeMaisContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CodigoIATA,Nome,Cidade,Estado")] Aeroporto aeroporto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CodigoIATA,Nome,Cidade,Estado")] Aeroporto aeroporto)
        {
            if (id != aeroporto.Id)
            {
                return NotFound();
